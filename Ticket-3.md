## 🧾 Ticket #3 – New Starter Onboarding: Yusuf Khan

- **Ticket ID:** INC00XXXXX  
- **Caller:** Carolina Kinlaw (Line Manager)  
- **New Starter:** Yusuf Khan  
- **Department:** Finance  
...
- Created Yusuf Khan’s user account in ServiceNow (simulating Active Directory)  
- Assigned username: `yusuf.khan`  
- Set temporary password: `Welcome#2025`  
- Provisioned Outlook mailbox (simulated)  
...
Completed onboarding setup for Yusuf Khan. User account created, temporary password issued, and access provided to email, shared drives, printer, and Teams (all simulated). Setup verified with line manager. Issue resolved.
